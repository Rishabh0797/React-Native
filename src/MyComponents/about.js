                ...
                <div className="carousel-inner">
                    <div className="carousel-item active bg-crousel">
                        <div className="img-gradient">
                            <img src="./assets/slide/photo-1526256262350-7da7584cf5eb.jpeg" className="d-block w-100 crousel_img" alt="..." />
                        </div>
                    ...
                    <div className="carousel-item">
                        <div className="img-gradient">
                            <img src="./assets/slide/photo-1576091160550-2173dba999ef.jpeg" className="d-block w-100 crousel_img" alt="..." />
                        </div>
                    ...
                    <div className="carousel-item">
                        <div className="img-gradient">
                            <img src="./assets/slide/photo-1584982751601-97dcc096659c.jpeg" className="d-block w-100 crousel_img" alt="..." />
                        </div>
                        <div className="carousel-caption d-md-block text-center">
                    ...
                    <div className="section-title">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <img src="./assets/slide/images.jpg" height="100%" width="100%" />
                            </div>
                            <div className="col-md-6 pt-4 pt-lg-0 d-flex flex-column justify-content-center content">
                                ...
                                <p>Getmeds! have been putting forth pharmacy administrations to our clients for more than 100 years. We know the pharmacy and wellbeing and magnificence industry back to front, continually guaranteeing we offer the most breakthrough items and medications. We bring our customers the best quality administration and give the nearby network and neighboring wards with a brilliant, understanding centered administration.</p>
                            </div>
                        </div>
                    </div>
                </div>
